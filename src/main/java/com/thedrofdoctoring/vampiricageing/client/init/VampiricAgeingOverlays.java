...
import com.thedrofdoctoring.vampiricageing.client.overlay.TaintedSunOverlay;
...
public class VampiricAgeingOverlays {
    ...
    public static void registerOverlays(RegisterGuiLayersEvent event) {
        ...
        event.registerAbove(VanillaGuiLayers.CAMERA_OVERLAYS, VampiricAgeing.rl("tainted_sun_overlay"), new TaintedSunOverlay());
