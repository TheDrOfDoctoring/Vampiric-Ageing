...
public class HunterAgeingConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends Double>> ageEnemyFactionDamageIncrease;
    ...
    static {
        ...
        taintedBloodMaxHealthIncreases = COMMON_BUILDER.comment("Max health bonus at each age rank. This replaces the regular age rank max health bonus").defineList("taintedMaxHealthBonus", Arrays.asList(0d, 0d, 1d, 1d, 2d, 2d, 3d, 3d, 4d, 4d, 5d, 5d), t -> true);
