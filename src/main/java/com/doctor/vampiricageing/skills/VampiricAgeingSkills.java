...
public class VampiricAgeingSkills {
    ...
    public static final RegistryObject<ISkill> LIMITED_BAT_MODE_SKILL = SKILLS.register("limited_bat_mode_skill", () -> new ActionSkill<>(VampiricAgeingActions.LIMITED_HUNTER_BATMODE_ACTION, false));
