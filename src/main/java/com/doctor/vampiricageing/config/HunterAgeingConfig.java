...
public class HunterAgeingConfig {
    ...
    static {
        ...
        taintedDamageBonuses = COMMON_BUILDER.comment("Damage bonus at each cumulative   age rank").defineList("taintedDamageBonus", Arrays.asList(0f, 0f, 0f, 1f, 1.5f, 1.75f, 2f, 2.5f, 2.5f, 3f, 5f, 6.5f), t -> t instanceof Float);
        ...
        taintedBloodMaxHealthIncreases = COMMON_BUILDER.comment("Max health bonus at each age rank").defineList("taintedMaxHealthBonus", Arrays.asList(0f, 0f, 0f, 0f, 0f, 0f, 4f, 4f, 6f, 8f, 8f, 10f), t -> t instanceof Float);
