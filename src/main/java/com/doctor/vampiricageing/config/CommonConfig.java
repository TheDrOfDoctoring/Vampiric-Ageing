...
public class CommonConfig {
    ...
    static {
        ...
        maxHealthIncrease = COMMON_BUILDER.comment("Max Health Increase for each rank. This is addition, not multiplier based").defineList("maxHealthIncrease", Arrays.asList(0D, 6D, 8D, 10D, 12D, 14D), t -> t instanceof Double);
