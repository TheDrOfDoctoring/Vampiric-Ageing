...
public class CommonConfig {
    ...
    public static final ForgeConfigSpec.IntValue bloodlossDamageThreshold;
    public static final ForgeConfigSpec.DoubleValue bloodlossScaleFactor;
    ...
    public static final ForgeConfigSpec.IntValue goldenAppleNoEatRank;
    ...
    static {
        ...
        stepAssistBonus = COMMON_BUILDER.comment("The Age Rank at which a vampire gains step assist. Set to 6 to disable. ").defineInRange("stepAssistLevel", 2, 0, 6);
