...
public class CommonConfig {
    ...
    static {
        ...
        stepAssistBonus = COMMON_BUILDER.comment("The Age Rank at which a vampire gains step assist. Set to 0 to disable. ").defineInRange("levelToBeginAgeMechanic", 3, 0, 5);
        ...
        highAgeBadOmen = COMMON_BUILDER.comment("When enabled, there is a chance to randomly get the Bad Omen effect as a High Age Vampire").define("highAgeOmen", false);
