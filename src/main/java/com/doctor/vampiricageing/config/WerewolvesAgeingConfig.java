...
public class WerewolvesAgeingConfig {
    ...
    static {
        ...
        silverOilDamageMultiplier = COMMON_BUILDER.comment("How much each rank multiplies damages from Silver Oil").defineList("silverOilMultiplier", Arrays.asList(1f, 1f, 1.25f, 1.5f, 1.75f, 2f), it -> it instanceof Float);
