...
public class EntityTypeTagProvider extends EntityTypeTagsProvider {
    ...
    public static final TagKey<EntityType<?>> pettyHuntVampire = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(VampiricAgeing.MODID, "petty_hunt_vampire"));
    public static final TagKey<EntityType<?>> commonHuntVampire = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(VampiricAgeing.MODID, "common_hunt_vampire"));
    public static final TagKey<EntityType<?>> greaterHuntVampire = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(VampiricAgeing.MODID, "greater_hunt_vampire"));
    ...
    protected void addTags() {
        ...
        this.tag(commonDevour).add(EntityType.SPIDER, EntityType.CAVE_SPIDER, EntityType.CREEPER, EntityType.GHAST, EntityType.BLAZE, EntityType.ENDERMAN, EntityType.GUARDIAN, ModEntities.HUNTER.get(), ModEntities.VAMPIRE_IMOB.get(), ModEntities.HUNTER_IMOB.get(),  ModEntities.VAMPIRE.get(), de.teamlapen.werewolves.core.ModEntities.WEREWOLF_SURVIVALIST.get(), de.teamlapen.werewolves.core.ModEntities.ALPHA_WEREWOLF.get());
